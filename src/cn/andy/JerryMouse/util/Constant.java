...
public class Constant {
    ...
    // 获得webapps方式1: 获得webapps文件夹 地址，构建 File(...\webapps\ROOT (默认路径))
    public final static File webappsFolder = new File(SystemUtil.get("user.dir"),"src\\webapps");
    public final static  File rootFolder = new File(webappsFolder,"ROOT");
    // 获得webapps方式2: 获得server.xml文件进行解析, 构建 File(...\conf\server.xml)
